    ...
    <Layout>
      ...
      <div className="brother-strategy">
        ...
        <Container className="container flexed margin-top-minus-150">
          <Row className="align-items-center">
            ...
            <Col className="content-container column step-text-block" xl={4}>
              <h3 className="">YOU CAN’T AFFORD TO BE OUTDATED</h3>
              <p>
                This approach is focused on targeting a standard business owner.
                Oriented from a cost and value perspective, we will identify the
                business cases that indicate the need for a new printer/scanner
                solution.
              </p>
              <p>
                It will speak primarily to C-level and office managers. Through
                the content and visuals, we will aid them in identifying the
                benefits of new technology and how it can improve their
                business. We will also introduce fear of appearing less
                professional because of the outdated printer.
              </p>
            </Col>
          </Row>
        </Container>
        <Container className="concept-1-background concept-display-section">
          <Row className="align-items-center">
            <Col className="content-container column white-text" xl={6} lg={8}>
              ...
              <p>
                The landing page will make use of a simple visual style backed
                by business outcome-oriented content to help drive value
                assessments of printing and scanning solutions.
              </p>
              <p>
                Examples include: difficult/more expensive to maintain their
                printer, challenging to connect to, constant jams/technical
                errors, staff avoid using it when possible.
              </p>
              <p>
                There will be simple animations to show technology
                transformation, from the old to new Brother solution. The
                animations will drive down the page where client use-cases and
                specific products can be pushed.
              </p>
            </Col>{" "}
            <Col
          ...
          <Row className="align-items-center">
            ...
            <InlineVideo videoID={"vi5n77gqx9"} className="box-shadow" />
          </Row>
          <Row className="flex-col">
            <h3 class="white-text title margin-top-80">Concept 1</h3>
            <img
              src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/LP-1-–-142.png"
              onClick={e => {
            ...
            />
            <img
              src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/LP-1-–-15.png"
              id="concept-1-alt"
              onClick={e => {
                e.target.style.display = "none";
                document.getElementById("concept-1-img").style.display =
                  "block";
              }}
              className="box-shadow"
            />
        ...
        <Container className="container flexed">
          <Row className="align-items-center">
            <Col className="content-container column" xl={5} lg={6}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/Group-9122-2.png" />
            </Col>
            <Col
              className="content-container column step-text-block"
              xl={6}
            ...
            >
              ...
              <p>
                Flyer design will support two different goals: product
                information and features/benefits.
              </p>
              <p>
                The content of the flyers will identify common printer
                shortcomings or failures and address them with Brother products
                or features.
              </p>
            </Col>
          </Row>
        ...
        <Container className="container flexed">
          <Row className="align-items-center blue-background-offset">
            ...
            >
              ...
              <p>
                The email design and copy will be simple and straightforward.
                For this concept, the subject line of the emails will be direct
                and business-focused.
              </p>
              <p>
                The call to action will be one of two things: a direct link to
                the landing page or to a specific product.
              </p>
              <p>When pushing specific products, we can have several CTAs</p>
            </Col>
            <Col className="content-container column f-o-0-m" xl={5}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/c1-phone.png" />
            </Col>
          </Row>
        </Container>
        <Container className="container flexed navy-circle">
          <Row className="align-items-center">
            <Col className="content-container column" xl={6}>
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/Ad_2.png"
            ...
            >
              ...
              <p>
                With Google Display ads, the visuals will be focused on a direct
                comparison between outdated printers and a new brother. We want
                to aim for visual clarity, so the older printer will be obvious
                compared to a new Brother.
              </p>
              <p>
                The content of the ads will be simple and focus on features. For
                example: NFC connectivity, ppm, or cost of use/maintenance.
              </p>
              <p>Remarketing will push specific products.</p>
            </Col>
          </Row>
          <Row className="align-items-center blue-circle hollow-navy-circle">
            <Col className="content-container column z-index-10 " xl={12}>
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/Ad_1.png"
                className="box-shadow-3"
              />
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/05/Ad-3.png"
        ...
        <Container className="concept-2-background concept-display-section">
          ...
          <Row className="align-items-center">
            <h3 class="white-text title">Video</h3>
            <InlineVideo videoID={"ovnmwpyibf"} />
          </Row>
          <Row className="flex-col">
