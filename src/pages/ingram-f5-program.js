      ...
      <div className="fortinet-lp">
        <Container className="container fortinet-ingram-background hero swish">
          <Row className="z-index-999">
            <Col className="display-flex content-container column flex-dir-col">
              <h1>Ingram Micro & F5 Partner Enablement Program</h1>
            ...
            <Col className="content-container column align-vertical video-container ">
              <video
                ...
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2021/07/Ingram%20Micro%20%26amp%3B%20F5%20Partner%20Enablement.mp4"
                alt="F5 Ingram Partner Video"
                id="video-player"
                autoPlay
                loop
                muted
              ></video>
              <Yourvideo videoID={"uqgtciyri1"} />
            </Col>
          </Row>
        </Container>
        <Container className="container white-section">
          <Row>
            <Col className="content-container max-width-children grey-text">
              ...
              <p className="centered-text">
                Ingram Micro and F5 are committed to the success of your
          ...
          <Row className="blob-container">
            <IngramPartnerForm
              formClassName={"F5"}
              formName={"ingram-f5-lp"}
              formActionURL={"/ingram-f5-program"}
            />
