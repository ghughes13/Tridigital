...
const WarmupTOS = () => {
  return (
    <Layout>
      <SEO title="Marketing Warmup Terms of Service" />
      <div className="TOS-Page mkt-warmup-tos">
        <Container className="container">
          <h1>TRIDIGITAL MARKETING TERMS OF SERVICE</h1>
          ...
          <ol>
            ...
            <li>
              Some of TRIdigital’s services may guarantee to deliver a minimum
              number of leads to you. Lead guarantees are calculated using a
              rolling quarterly average (an average of the last three months).
              By subscribing, you agree that a “Lead” is defined as the
              occurrence of any of the following*:
              <ol>
                <li>
                  Your receipt of an email sent from a contact in response to a
                  marketing campaign
                </li>
                <li>
                  A download of assets from any of your landing pages or
                  websites
                </li>
                <li>
                  A phone call generated to you from any of your landing pages
                  or websites
                </li>
                <li>
                ...
                <li>
                  ...
                  landing pages, websites, marketing emails or newsletter
                  campaigns
                </li>
              </ol>
            </li>
          ...
          *A contact must meet a minimum seat size of 10 in your target market
          ...
          <span>
            ...
            to send them out. If this occurs, the warm lead guarantee is void.
            However, deliverables will still be created for the length of the
            agreement.
          </span>
          <h3>Edits</h3>
          <span>
            The Warmup is a templated service built to generate leads by
