      ...
      <div className="carolina-strategy">
        ...
        >
          <Row className="align-items-center ">
            <Col className="content-container column">
              <div className="card">
                <img
                  ...
                  src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9126.png"
                />
                <p>Concept 1</p>
                <h3>VALUE-DRIVEN, PRAGMATIC CYBERSECURITY</h3>
                <Link
                  href="#concept-1"
                  className="blue-btn"
                  to="concept-1"
            ...
            <Col className="content-container column card-container">
              <div className="card">
                <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9131.png" />
                <p>Concept 2</p>
                <h3>PEACE OF MIND</h3>
                <Link
                  href="#concept-2"
          ...
          <Row className="align-items-center">
            ...
            >
              <img
                ...
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/C3_Isometric_Concept_1.png"
              />
            </Col>
            <Col className="content-container column step-text-block" xl={4}>
              <h3 className="">VALUE-DRIVEN, PRAGMATIC CYBERSECURITY</h3>
              <p>
                This concept is focused on around palatable, professional design
                and content. It’s a more no-frill, straightforward and pragmatic
                approach to establishing brand identity.
              </p>
              <p>
                With colors, animations and concise headers, we can establish a
                clear identity as a cybersecurity company. Backed by an easy to
                understand and navigate design, many executives will feel right
                at home when interacting with C3’s marketing material.
              </p>
            </Col>
          </Row>
        </Container>
        <Container className="concept-1-background concept-display-section">
          <Row className="align-items-center">
            ...
            >
              ...
              <p>
                ...
                is to, in one fell swoop, increase awareness of cybersecurity
                and establish C3 as a reputable source.
              </p>
            </Col>{" "}
            <Col
              className="content-container column step-text-block"
          ...
          <Row className="align-items-center">
            ...
            <InlineVideo videoID={"2brj5oyimm"} className="box-shadow" />
          </Row>
          <Row className="flex-col">
            <h3 class="white-text title margin-top-80">Concept 1</h3>
            <img
              src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/C3-1.png"
              id="concept-2-orig"
            />{" "}
          </Row>
        </Container>
        <Container className="container flexed">
          <Row className="align-items-center">
            <Col className="content-container column" xl={5} lg={6}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9133.png" />
            </Col>
            <Col
              className="content-container column step-text-block"
              xl={6}
        ...
        <Container className="container flexed">
          <Row className="align-items-center blue-background-offset">
            ...
            <Col className="content-container column f-o-0-m" xl={5}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9134.png" />
            </Col>
          </Row>
        </Container>
        <Container className="container flexed navy-circle">
          <Row className="align-items-center">
            <Col className="content-container column z-index-10" xl={6}>
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Screen-Shot-2020-05-29-at-3.27.52-PM.png"
                className="box-shadow-3"
              />
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Screen-Shot-2020-05-29-at-3.27.44-PM.png"
            ...
            >
              ...
              <p>
                Businesscards will use the same callout as the homepage hero
                content. It uses a dramatic design with a gripping tagline to
                help them relate C3 to cybersecurity.
              </p>
            </Col>
          </Row>
        ...
        <Container className="container flexed">
          <Row className="align-items-center">
            <Col
              ...
              id="concept-2"
            >
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/C3_Isometric_Concept_2-copy-1.png" />
            </Col>
            <Col className="content-container column step-text-block" xl={4}>
              <h3 className="">PEACE OF MIND</h3>
              <p>
                With this concept, we want to immediately conjure a relationship
                between C3 and the western North Carolina region. By leading
                with imagery that conjures a peaceful feeling, we can
                immediately drive to the key impact C3’s services have for their
                clients: the peace of mind of being secure.
              </p>
              <p>
                All materials are designed to elicit this same emotion and
                identity. Instead of leading with fear-driving words like risk,
                vulnerability and breach, we can focus on positive outcomes and
                lead with that peace of mind mentality.
              </p>
            </Col>
          </Row>
        </Container>
        <Container className="concept-2-background concept-display-section">
          ...
          <Row className="align-items-center">
            <h3 class="white-text title">Video</h3>
            <InlineVideo videoID={"5nkvwvgm2z"} />
          </Row>
          <Row className="flex-col">
            <h3 class="white-text title margin-top-80">Concept 2</h3>
            <img
              src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Screen-Shot-2020-06-01-at-11.22.28-AM.png"
              id="concept-2-orig"
            />
          </Row>
        </Container>
        <Container className="container flexed">
          <Row className="align-items-center">
            <Col className="content-container column" xl={5} lg={6}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9137.png" />
            </Col>
            <Col
              className="content-container column step-text-block"
              xl={6}
        ...
        <Container className="container flexed">
          <Row className="align-items-center blue-background-offset purple">
            ...
            <Col className="content-container column f-o-0-m" xl={5}>
              <img src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Group-9138.png" />
            </Col>
          </Row>
        </Container>
        <Container className="container flexed navy-circle">
          <Row className="align-items-center">
            <Col className="content-container column z-index-10" xl={6}>
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Screen-Shot-2020-06-01-at-11.59.51-AM.png"
                className="box-shadow-3"
              />
              <img
                src="https://encrypted.tridigitalmarketing.com/wp-content/uploads/2020/06/Screen-Shot-2020-06-01-at-8.25.42-AM.png"
                className="box-shadow-3 margin-top-50"
              />
            </Col>
            <Col
